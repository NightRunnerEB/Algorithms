...
graph3 = nx.DiGraph()
graph3.add_edge('A', 'B', capacity=3)
graph3.add_edge('A', 'C', capacity=1)
graph3.add_edge('A', 'D', capacity=5)
graph3.add_edge('B', 'E', capacity=3)
graph3.add_edge('C', 'E', capacity=1)
graph3.add_edge('D', 'E', capacity=7)
graph3.add_edge('E', 'F', capacity=1)
print(f"Необходимо удалить {disconnect_nodes(graph3, 'A', 'F')} вершин, чтобы разорвать связь между A и F")
